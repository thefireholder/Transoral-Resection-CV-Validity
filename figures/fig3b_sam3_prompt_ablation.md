...
|---|---|---|---|---|---|---|---|
| SAM3 (text prompt, zero-shot) | n/p | n/p | n/p | n/p | n/p | n/p | class-name text prompts: detect + classify + segment, zero-shot |
| SAM3 (YOLO boxes) | n/p | n/p | n/p | n/p | n/p | n/p | YOLO11n boxes (+class, +score) as prompts: SAM3 only draws the mask |
