...
# ---------------------------------------------------------------------------
MODELS = {
    # label = legend / panel title,  short = table header,  color = Okabe-Ito (colour-blind safe)
    "maskrcnn": {"label": "Mask R-CNN",           "short": "Mask R-CNN", "color": "#0072B2"},
    "yolo":     {"label": "YOLO11n-seg",          "short": "YOLO11n",    "color": "#E69F00"},
    "sam3":     {"label": "SAM3 (GT-box prompt)", "short": "SAM3",       "color": "#009E73"},
...
FIG1A_MODELS = ["maskrcnn", "yolo", "monai"]  # SAM3 has no training curve; MONAI's appears after its rerun
...
FIG1B_SCORE_THRESHOLD = {"maskrcnn": 0.5, "yolo": 0.25, "sam3": 0.0, "monai": 0.0}
FIG1B_ALPHA = 0.45
